...
${BLUE}%n${NO_COLOUR}@%m %40<...<%B%~%b%<< "'${VCS_INFO_message_0_}'"%# "
        ...
        if (( EUID != 0 )); then
            ...
            PROMPT="${RED}${EXITCODE}${WHITE}${debian_chroot:+($debian_chroot)}%{$fg_bold[green]%}%n@%m ${BLUE}%40<...<%B%~%b%<< "'${VCS_INFO_message_0_}'"%# "
        else
            #PROMPT="${BLUE}${EXITCODE}${WHITE}${debian_chroot:+($debian_chroot)}${RED}%n${NO_COLOUR}@%m %40<...<%B%~%b%<< "'${VCS_INFO_message_0_}'"%# "
            PROMPT="${BLUE}${EXITCODE}${WHITE}${debian_chroot:+($debian_chroot)}%{$fg_bold[red]%}%n%{$fg_no_bold[white]%}@%m ${BLUE}%40<...<%B%~%b%<< "'${VCS_INFO_message_0_}'"%# "
        fi
    fi
fi
